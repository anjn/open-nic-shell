...
// --------------------------------------------------
//    0x0000  |   0x1FFF  |  XXVMAC IP block
// --------------------------------------------------
//    0x2000  |   0x2FFF  |  QSFP28 I2C
// --------------------------------------------------
`include "open_nic_shell_macros.vh"
`timescale 1ns/1ps
module xxvmac_subsystem_address_map (
  ...
  output        m_axil_xxvmac_awvalid,
  output [31:0] m_axil_xxvmac_awaddr,
  input         m_axil_xxvmac_awready,
  output        m_axil_xxvmac_wvalid,
  output [31:0] m_axil_xxvmac_wdata,
  input         m_axil_xxvmac_wready,
  input         m_axil_xxvmac_bvalid,
  input   [1:0] m_axil_xxvmac_bresp,
  output        m_axil_xxvmac_bready,
  output        m_axil_xxvmac_arvalid,
  output [31:0] m_axil_xxvmac_araddr,
  input         m_axil_xxvmac_arready,
  input         m_axil_xxvmac_rvalid,
  input  [31:0] m_axil_xxvmac_rdata,
  input   [1:0] m_axil_xxvmac_rresp,
  output        m_axil_xxvmac_rready,
  ...
  localparam C_XXVMAC_INDEX = 0;
  localparam C_QSFP_INDEX = 1;

  localparam C_XXVMAC_BASE_ADDR = 32'h0;
  ...
  assign axil_xxvmac_awaddr                      = axil_awaddr[`getvec(32, C_XXVMAC_INDEX)] - C_XXVMAC_BASE_ADDR;
  assign axil_xxvmac_araddr                      = axil_araddr[`getvec(32, C_XXVMAC_INDEX)] - C_XXVMAC_BASE_ADDR;
  ...
  assign m_axil_xxvmac_awvalid                   = axil_awvalid[C_XXVMAC_INDEX];
  assign m_axil_xxvmac_awaddr                    = axil_xxvmac_awaddr;
  assign axil_awready[C_XXVMAC_INDEX]            = m_axil_xxvmac_awready;
  assign m_axil_xxvmac_wvalid                    = axil_wvalid[C_XXVMAC_INDEX];
  assign m_axil_xxvmac_wdata                     = axil_wdata[`getvec(32, C_XXVMAC_INDEX)];
  assign axil_wready[C_XXVMAC_INDEX]             = m_axil_xxvmac_wready;
  assign axil_bvalid[C_XXVMAC_INDEX]             = m_axil_xxvmac_bvalid;
  assign axil_bresp[`getvec(2, C_XXVMAC_INDEX)]  = m_axil_xxvmac_bresp;
  assign m_axil_xxvmac_bready                    = axil_bready[C_XXVMAC_INDEX];
  assign m_axil_xxvmac_arvalid                   = axil_arvalid[C_XXVMAC_INDEX];
  assign m_axil_xxvmac_araddr                    = axil_xxvmac_araddr;
  assign axil_arready[C_XXVMAC_INDEX]            = m_axil_xxvmac_arready;
  assign axil_rvalid[C_XXVMAC_INDEX]             = m_axil_xxvmac_rvalid;
  assign axil_rdata[`getvec(32, C_XXVMAC_INDEX)] = m_axil_xxvmac_rdata;
  assign axil_rresp[`getvec(2, C_XXVMAC_INDEX)]  = m_axil_xxvmac_rresp;
  assign m_axil_xxvmac_rready                    = axil_rready[C_XXVMAC_INDEX];
  ...
  xxvmac_subsystem_axi_crossbar xbar_inst (
...
endmodule: xxvmac_subsystem_address_map
